...
//  DailyDiscipline
//
//  Created by Harry Karl Filip Karlsson on 2022-12-07.
//
...
class DataModel: ObservableObject {
    ...
    func getTaskFromCategory(type: String){
        urlString = "https://www.boredapi.com/api/activity?type=\(type.lowercased())"
        if type == "Random"{
            urlString = "https://www.boredapi.com/api/activity?"
        }
